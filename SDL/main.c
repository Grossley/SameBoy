...
static uint32_t pixel_buffer_1[256 * 224], pixel_buffer_2[256 * 224], bg_pixel_buffer[256 * 224];
...
int main(int argc, char **argv)
{
    ...
    window = SDL_CreateWindow("SameBoy + WideGB v" GB_VERSION, SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED,
