...
- (void)screenSizeChanged
{
    ...
    image_buffers[0] = calloc(1, bufferSize);
    image_buffers[1] = calloc(1, bufferSize);
    image_buffers[2] = calloc(1, bufferSize);
    bg_image_buffers[0] = calloc(1, bufferSize);
    bg_image_buffers[1] = calloc(1, bufferSize);
    bg_image_buffers[2] = calloc(1, bufferSize);
